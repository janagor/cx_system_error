...
# requested by cx_system_error_enable_sanitizers can be inspected, then asserts
...
if(compile_options MATCHES "leak")
  message(FATAL_ERROR "Leak sanitizer must not be enabled on Apple platforms (#141), "
...
if(NOT
   ...
   MATCHES
   "address")
  message(FATAL_ERROR "Address sanitizer should still be enabled when leak is filtered out, "
